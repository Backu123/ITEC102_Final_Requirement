    ...
    internal class Activity_1
    {
        ...
        public void Arrangement()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                int indexToRemove = ran.Next(0, numbers.Count);
                if (numbers[indexToRemove] == 1)
                {
                    Multiple_Choices8();
                }
                else if (numbers[indexToRemove] == 2)
                {
                    Multiple_Choices10();
                }
                else if (numbers[indexToRemove] == 3)
                {
                    Multiple_Choices2();
                }
                else if (numbers[indexToRemove] == 4)
                {
                    Multiple_Choices3();
                }
                else if (numbers[indexToRemove] == 5)
                {
                    Multiple_Choices1();
                }
    ...
    internal class Midterms
    {
        ...
        public void Arrangement()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                else if (numbers[indexToRemove] == 6)
                {
                    Fill_Question1();
                }
                else if (numbers[indexToRemove] == 7)
                {
                    Fill_Question5();
                }
                else if (numbers[indexToRemove] == 8)
                {
                    Fill_Value4();
                }
                else if (numbers[indexToRemove] == 9)
                {
                    Given14();
                }
                else if (numbers[indexToRemove] == 10)
                {
                    Given15();
                }
                numbers.RemoveAt(indexToRemove); // remove the element at index 2
