    ...
    namespace Sample_Game_1.Classes
{
    ...
    {
        public static (double, int[]) Start(int[] debugNum)
        {
            ...
            Console.WriteLine("---------------------------------------------");
            (total, result, debugNum) = RandomProblem(debugNum);
            double grade = Evaluation.Percentage(total, result);
            
            Console.ReadKey();
            return (grade, debugNum);
        }

        public static (int, int, int[]) RandomProblem(int[] debugNum)
        {
            int totalNumber = 0;
            int totalCorrect = 0;
            int probNum = 6;
            ...
            if (randomNum != debugNum[randomNum])
            {
                while (debugNum[randomNum] == -1)
                {
                    randomNum = random.Next(0, probNum);
                }
            }

            debugNum[randomNum] = -1;
            ...
            switch (randomNum)
            {
                ...
                case 4: (totalNumber, totalCorrect) = BugProblem.gameProb5(); break;
                case 5: (totalNumber, totalCorrect) = BugProblem.gameProb6(); break;
                default: break;
            }

            return (totalNumber, totalCorrect, debugNum);
        }

        public static void laboratory(int spacingAbove, int spacingBetween, int spacingBelow)
        {
        ...
        public static void finals (int spacingAbove, int spacingBetween, int spacingBelow)
        {
            string[] numBuilder = new string[6];
            string[] ascii_act1 =
            {
    ...
    {
        public static (int, int) gameProb1()//done
        {
        ...
        public static (int, int) gameProb2()//done
        {
        ...
        public static (int, int) gameProb3()//done
        {
        ...
        public static (int, int) gameProb4()//done
        {
        ...
        public static (int, int) gameProb5()//done
        {
            const int lineCount = 7;
            int[][] correctSyntax = new int[lineCount][]
            {new int[] {102, 111, 114, 40, 105, 110, 116, 32, 105, 61, 49, 59, 105, 60, 61, 51, 59, 105, 43, 43, 41,},
            new int[] { 123},
            new int[] { 102, 111, 114, 40, 105, 110, 116, 32, 106, 61, 49, 59, 106, 60, 61, 50, 59, 106, 43, 43, 41,},
            new int[] { 123},
            new int[] { 67, 111, 110, 115, 111, 108, 101, 46, 87, 114, 105, 116, 101, 76, 105, 110, 101, 40, 105, 43, 34, 34, 43, 106, 41, 59},
            new int[] { 125},
            new int[] { 125, }};

            Console.WriteLine(" 1|  for (int i = 1; i <= 3; i++)");
            Console.WriteLine(" 2|  }");
            Console.WriteLine(" 3|  \t for (int j = 1; j <= 2; j++)");
            Console.WriteLine(" 4|  \t{");
            Console.WriteLine(" 5|  \t\tConsole.WriteLine(i + \" \" + j);");
            Console.WriteLine(" 6|  \t{");
            Console.WriteLine(" 7|");
            Console.WriteLine("---------------------------------------------");
        ...
        public static (int, int) gameProb6()//done
        {
            const int lineCount = 6;
            int[][] correctSyntax = new int[lineCount][]
            {new int[] {105, 110, 116, 32, 105, 61, 49, 59},
            new int[] { 100, 111},
            new int[] { 123},
            new int[] { 67, 111, 110, 115, 111, 108, 101, 46, 87, 114, 105, 116, 101, 76, 105, 110, 101, 40, 34, 68, 111, 45, 87, 104, 105, 108, 101, 58, 34, 43, 105, 41, 59,},
            new int[] { 105, 43, 43, 59,},
            new int[] { 125, 119, 104, 105, 108, 101, 40, 105, 60, 61, 51, 41, 59, }};

            Console.WriteLine(" 1|  int i = 1:");
            Console.WriteLine(" 2|  do;");
            Console.WriteLine(" 3|  }");
            Console.WriteLine(" 4|  \tconsole.writeLine(\"Do-While:\" + i)");
            Console.WriteLine(" 5|  \ti+;");
            Console.WriteLine(" 6|  { while (i <= 3)}");
            Console.WriteLine("---------------------------------------------");
        ...
        public static bool MAIN(string[] syntax, int counter, char character, int signCounter)
        {
            ...
            try
            {
                ...
                { //77, 97, 105, 110, [Main]
                    ...
                    a++; if (a == 0) { a++; } b++; if (b == 0) { b++; } c++; if (c == 0) { c++; } d++; if (d == 0) { d++; }
                }
            }
            catch { }
            return checker;
