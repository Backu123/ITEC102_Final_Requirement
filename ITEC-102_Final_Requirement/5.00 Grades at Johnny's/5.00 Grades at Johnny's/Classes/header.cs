    ...
    public class Header
    {
        ...
        public static void title()
        {
            ...
            for (int i = 0; i < asciiTitle.Length; i++)
            {
                ...
                for (int spaces = 0; spaces < ((Console.WindowWidth / 2) - (asciiTitle[0].Length / 2) - 4); spaces++) { Console.Write(" "); }
                Console.Write(asciiTitle[i]);
                for (int spaces = 0; spaces < ((Console.WindowWidth / 2) - (asciiTitle[0].Length / 2) - 1); spaces++) { Console.Write(" "); }
                Console.ResetColor();
                Console.Write("║");
                Console.WriteLine("█");
            }
